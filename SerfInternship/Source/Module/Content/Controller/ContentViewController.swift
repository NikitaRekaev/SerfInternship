...
final class ContentViewController: BaseViewController<ContentRootView> {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        selfView.setInfiniteCollectionDelegate(dataSource: topCollectionDataSource, delegate: topCollectionDelegate)
        selfView.setAnimatedCollectionDelegate(dataSource: middleCollectionDataSource, delegate: middleCollectionDelegate)
